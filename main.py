...
def Main():
    ...
    # train_metadata, test_metada = data.get_meta_data()
    ...
    for index in range(1, 20):
        ...
        train_processor.register_processor([train_crop_processor])
        ...
        classification = train_metadata[0]
        # test_data = test_processor.Process(test_data)
        cv2.imshow("{}.png".format(str(classification)), train_data[0])
        cv2.waitKey(1)
